...
const SUITES = [
  ...
  ['smsStatus',     'smsStatus.test.js',     'pure — no database'],
  ['adminAlert',    'adminAlert.test.js',    'pure — no database'],
  ...
  ['dialFailure',   'dialFailure.test.js',   'needs DATABASE_URL'],
  ['escalation',    'escalation.test.js',    'needs DATABASE_URL'],
  ['api',           'api.test.js',           'needs DATABASE_URL'],
  ['verification',  'verification.test.js',  'needs DATABASE_URL'],
